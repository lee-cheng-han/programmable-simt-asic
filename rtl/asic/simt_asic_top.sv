module simt_asic_top #(
  ...
  asic_host_controller #(.IMEM_ADDR_W(IMEM_ADDR_W),
    ...
    .inject_fault_o(inject_fault),.bist_done_i(1'b0));
  ...
  simt_core #(.IMEM_WORDS(IMEM_WORDS), .IMEM_ADDR_W(IMEM_ADDR_W),
    ...
    .watchdog_limit_i(watchdog_limit),.host_mem_valid_i(host_mem_valid),
    .host_mem_shared_i(host_mem_shared),.host_mem_write_i(host_mem_write),
    .host_mem_address_i(host_mem_address),.host_mem_write_data_i(host_mem_write_data),
