...
| Round-robin scheduler services a continuously eligible warp within four accepted grants | `rtl/control/round_robin_arbiter.sv` | `tb/unit/tb_round_robin_arbiter.sv` | One-hot, requested-grant, and stalled-stability assertions; bounded formal pending | Warp × ready-count × wait bins pending | Partial: four-request fairness and backpressure verified |
