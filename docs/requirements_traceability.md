...
| Round-robin scheduler services a continuously eligible warp within four accepted grants | `rtl/control/round_robin_arbiter.sv`, `rtl/core/four_warp_core.sv` | `tb/unit/tb_round_robin_arbiter.sv`, `tb/integration/tb_four_warp_core.sv` | One-hot, requested-grant, and stalled-stability assertions; bounded formal pending | All four warps issue and retire; ready-count bins pending | Partial: integrated four-warp fairness and backpressure verified |
