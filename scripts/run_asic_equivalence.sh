...
sources='build/simt_isa_pkg.sv rtl/simt_gpu_pkg.sv formal/simt_core_equiv_model.sv rtl/asic/reset_synchronizer.sv rtl/asic/asic_host_controller.sv rtl/asic/simt_asic_top.sv'
