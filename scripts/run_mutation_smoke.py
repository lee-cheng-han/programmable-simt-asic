...
MUTATIONS = (
    ...
    Mutation(
        ...
        ("rtl/simt_gpu_pkg.sv", "rtl/memory/data_sram_bank_adapter.sv"),
    ...
    Mutation(
        "memory_validates_inactive_lanes",
        "rtl/memory/banked_vector_memory.sv",
        "if(request_mask_i[lane]) begin",
        "if(1'b1) begin",
        "tb_banked_vector_memory",
        ("rtl/simt_gpu_pkg.sv", "rtl/memory/data_sram_bank_adapter.sv"),
        "tb/unit/tb_banked_vector_memory.sv",
    ),
    Mutation(
        "memory_skips_fault_prevalidation",
        "rtl/memory/banked_vector_memory.sv",
        "if(request_fault||request_mask_i=='0) begin",
        "if(request_mask_i=='0) begin",
        "tb_banked_vector_memory",
        ("rtl/simt_gpu_pkg.sv", "rtl/memory/data_sram_bank_adapter.sv"),
        "tb/unit/tb_banked_vector_memory.sv",
    ),
    Mutation(
        "memory_wrong_bank_select",
        "rtl/memory/banked_vector_memory.sv",
        "if(!bank_used[address_q[lane][4:2]]&&\n           bank_request_ready[address_q[lane][4:2]]&&\n           !bank_response_valid[address_q[lane][4:2]]) begin",
        "if(!bank_used[address_q[lane][5:3]]&&\n           bank_request_ready[address_q[lane][5:3]]&&\n           !bank_response_valid[address_q[lane][5:3]]) begin",
        "tb_banked_vector_memory",
        ("rtl/simt_gpu_pkg.sv", "rtl/memory/data_sram_bank_adapter.sv"),
        "tb/unit/tb_banked_vector_memory.sv",
    ),
    Mutation(
        "tracker_allows_same_warp_overlap",
        "rtl/memory/memory_subsystem.sv",
        "assign request_ready_o=free_valid&&!warp_busy_o[request_warp_i]&&!fatal_i;",
        "assign request_ready_o=free_valid&&!fatal_i;",
        "tb_memory_subsystem",
        ("rtl/simt_gpu_pkg.sv", "rtl/execute/completion_queue.sv",
         "rtl/memory/data_sram_bank_adapter.sv",
         "rtl/memory/banked_vector_memory.sv"),
